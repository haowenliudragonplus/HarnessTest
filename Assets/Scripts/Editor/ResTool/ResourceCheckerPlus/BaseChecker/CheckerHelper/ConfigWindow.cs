...
namespace ResourceCheckerPlus
{
    ...
    public class ConfigWindow : EditorWindow
    {
        ...
        public static void Init()
        {
            ...
            exportResultPath = AssetDatabase.LoadAssetAtPath<Object>(ResourceCheckerPlus.instance.checkerConfig.checkResultExportPath);
        }
        ...
        void OnGUI()
        {
            CheckerCommonConfig config = ResourceCheckerPlus.instance.checkerConfig;
            if (config != null)
            {
                ...
                //config.highlightBackgroundColor = EditorGUILayout.ColorField("选中按钮高亮颜色", config.highlightBackgroundColor);
