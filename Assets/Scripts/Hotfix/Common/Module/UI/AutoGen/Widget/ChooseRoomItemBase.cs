...
public class ChooseRoomItemBase : UIWidgetBase
{
	...
	protected TextMeshProUGUI UITxt_DownLoadLabel;
    ...
    protected override void BindComponent()
    {
		...
		UITxt_DownLoadLabel = GO.transform.Find("UINode_DownLoadGroup/UISlider_DownLoadSlider/UITxt_DownLoadLabel").GetComponent<TextMeshProUGUI>();
