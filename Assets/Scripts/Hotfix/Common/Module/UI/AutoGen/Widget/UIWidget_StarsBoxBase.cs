...
public class UIWidget_StarsBoxBase : UIWidgetBase
{
	...
	protected RectTransform UINode_ActivityAddItems;
    ...
    protected override void BindComponent()
    {
		...
		UINode_ActivityAddItems = GO.transform.Find("UINode_ActivityAddItems").GetComponent<RectTransform>();
