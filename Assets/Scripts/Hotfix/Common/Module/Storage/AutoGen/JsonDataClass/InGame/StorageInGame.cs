...
{
    [System.Serializable]
    public class StorageInGame : StorageBase
    {
        ...
        // 成就
        [JsonProperty]
        StorageAchievement achievement = new StorageAchievement();
        [JsonIgnore]
        public StorageAchievement Achievement
        {
            get
            {
                return achievement;
